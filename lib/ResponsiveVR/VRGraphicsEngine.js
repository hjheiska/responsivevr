...
(function (VRGraphicsEngine, THREE, screen) {
	...
	var loadAndAddmesh = function(geometry, Object3D, elementWidth, elementHeight) {
		...
		var menuText = Object3D.vr.element.text;
		...
		if(typeof Object3D.vr.element.foregroundElement != 'undefined') {
			if(Object3D.vr.element.foregroundElement.image != null) {
				...
				menuText = "<img style='max-width:" + width + "px; max-height:" + height + "px' src='" + Object3D.vr.element.foregroundElement.image.source + "' />";
			}
		}
		
		var html = '<html><body style="margin: 0; padding; 0; position: relative"><div style="' + style + '">' + menuText + '</div></body></html>';
