		...
		function gotVRDevices( devices ) {
			...
			for ( var i = 0; i < devices.length; ++ i ) {
				if ( devices[i] instanceof HMDVRDevice ) {
					...
					self.leftEyeTranslation = eyeParamsL.eyeTranslation;
					self.rightEyeTranslation = eyeParamsR.eyeTranslation;
					self.leftEyeFOV = eyeParamsL.recommendedFieldOfView;
					self.rightEyeFOV = eyeParamsR.recommendedFieldOfView;
